      ...
      <div className="w-full max-w-md p-8 rounded-2xl bg-white " >
        <div className="flex flex-col items-center justify-center mb-8" >
          <motion.div
            ...
            className="relative w-24 h-24 mb-4 rounded-full bg-white flex items-center justify-center drop-shadow-xl"
          >
            <img src={hawk} alt="My SVG Image" width="200" height="200" />
